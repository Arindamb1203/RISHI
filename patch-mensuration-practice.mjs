/**
 * patch-mensuration-practice.mjs
 * Fixes both mensuration practice pages:
 *   1. Adds rishi-presence.js script tag
 *   2. Adds rishiIsExplainDone gate in init()
 *
 * Run from repo root: node patch-mensuration-practice.mjs
 */

import { readFileSync, writeFileSync } from 'fs';

const FILES = [
  'public/practice/class8/mensuration/area-plane-figures.html',
  'public/practice/class8/mensuration/surface-area-volume.html',
];
