/**
 * patch-algebra-practice.mjs
 * Fixes all 4 algebra practice pages:
 *   1. Adds rishi-presence.js script tag
 *   2. Adds rishiIsExplainDone gate in init()
 *
 * Run from repo root: node patch-algebra-practice.mjs
 */

import { readFileSync, writeFileSync } from 'fs';

const FILES = [
  'public/practice/class8/algebra/linear-equations.html',
  'public/practice/class8/algebra/algebraic-expressions-identities.html',
  'public/practice/class8/algebra/factorisation.html',
  'public/practice/class8/algebra/introduction-to-graphs.html',
];
