...
- **Rich chapters so far: Squares · Cubes · Exponents · Comparing Quantities · Rational Numbers · Playing with Numbers · Direct & Inverse Proportions (7).** Engine `rishi-animate.js` internal `version:3` label is stale/cosmetic (cache-bust is the `?v=` query, currently v4) — not bumped, harmless.
