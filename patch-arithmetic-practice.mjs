/**
 * patch-arithmetic-practice.mjs
 * Fixes all 5 arithmetic practice pages:
 *   1. Adds rishi-presence.js script tag
 *   2. Adds rishiIsExplainDone gate in init()
 *
 * Run from repo root: node patch-arithmetic-practice.mjs
 */

import { readFileSync, writeFileSync } from 'fs';

const FILES = [
  'public/practice/class8/arithmetic/rational-numbers.html',
  'public/practice/class8/arithmetic/comparing-quantities.html',
  'public/practice/class8/arithmetic/powers-exponents.html',
  'public/practice/class8/arithmetic/direct-inverse-proportions.html',
  'public/practice/class8/arithmetic/playing-with-numbers.html',
];

/* ── Fix 1: inject rishi-presence.js ── */
const SYNC_TAG   = '<script src="/rishi-sync.js"></script>';
const PRESENCE   = '\n<script src="/rishi-presence.js"></script>';

/* ── Fix 2: explain-done gate ── */
...
FILES.forEach(function(fp) {
  ...
  if (!src.includes('/rishi-presence.js')) {
    if (src.includes(SYNC_TAG)) {
      ...
      console.log('  ⚠ No rishi-sync.js tag found in: ' + fp);
    }
  }
